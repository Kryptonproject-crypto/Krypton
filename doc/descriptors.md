# Support for Output Descriptors in Krypton Core

Since Krypton Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `kyp1...` for mainnet or `tkyp1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Krypton's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Krypton Core wallets, a convenience function `combo` is

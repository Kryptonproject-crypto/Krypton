...
"""Verify that starting krypton with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start krypton with -h for help text")
        ...
        self.log.info("Start krypton with -version for version information")
        ...
        self.log.info("Start kryptond with -fakearg to make sure it does not start")

...
bech32_templates = [
  ...
  ('kyp',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('kyp',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('kyp',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tkyp',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tkyp',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tkyp',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rkyp',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rkyp',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rkyp', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tkyp',  17, 32, False, False, False),
  ('rkyp',  3,  1, False, False, False),
  ('kyp',   15, 41, False, False, False),
  ('tkyp',  0, 16, False, False, False),
  ('rkyp',  0, 32, True,  False, False),
  ('kyp',   0, 16, True,  False, False),
  ('tkyp',  0, 32, False, True,  False),
  ('rkyp',  0, 20, False, False, True)
]

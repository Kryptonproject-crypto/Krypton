...
**/
        progressBar->setStyleSheet("QProgressBar { background-color: #e8e8e8; max-height: 13px; border-radius: 7px; padding: 1px; text-align: center; min-width: 400px; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #10B9EA, stop: 1 #6408BF); border-radius: 7px; margin: 0px; min-width: 400px; } ");
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and krypton: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a krypton: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Krypton command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Krypton network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {

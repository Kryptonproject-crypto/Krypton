...
const char* BIP71_MIMETYPE_PAYMENT = "application/krypton-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/krypton-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/krypton-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start krypton: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("krypton://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'krypton://' is not a valid URI. Use 'krypton:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Krypton address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " krypton-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  krypton-tx [options] <hex-tx> [commands]  Update hex-encoded krypton transaction\n" +
            "or:     krypton-tx [options] -create [commands]   Create hex-encoded krypton transaction\n" +
            "\n";
